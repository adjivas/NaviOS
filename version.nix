...
in {
  ...
  environment.systemPackages = [
    ...
    (pkgs.writeTextDir "share/icons/hicolor/scalable/apps/nix-snowflake.svg" (builtins.readFile ./hosts/dreamland/Nix_Snowflake_Logo_Navi.svg))
    # (pkgs.writeTextDir "share/icons/hicolor/scalable/apps/nix-snowflake.svg" (builtins.readFile (self + ./hosts/dreamland/Nix_Snowflake_Logo_Navi.svg)))
  ];
