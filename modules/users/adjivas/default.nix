{
  ...
  in {
    ...
    home.shellAliases = {
      ...
      to-pdf = "${pkgs.imagemagick}/bin/magick -density 300 -compress Zip";
      age-encrypt = "${pkgs.parallel}/bin/parallel --will-cite age --recipients-file ${homeDir}/.agenix/agenix/recipients -o {}.age {} :::";
