{
  den.aspects.dream00-multiseat.nixos = {lib, ...}: {
    ...
    services.udev.extraRules = ''
      ...
      SUBSYSTEM=="sound", KERNEL=="card*", KERNELS=="0000:04:00.0", ENV{ID_SEAT}="seat1"
      ...
      SUBSYSTEM=="drm", KERNEL=="card*", KERNELS=="0000:03:00.0", SYMLINK+="dri/arc"
