{ pkgs, lib, config, ... }: {
        ...
        <inkscape
          ...
          <group
            ...
            <eventcontext
               ...
               use_svg2="1"
               style="line-height:1.25;font-family:sans-serif;font-size:40px;text-orientation:auto"
               selcue="1"
               align_mode="0"
               writing_mode="0"
               orientation_mode="0"
            ...
            <eventcontext
               ...
               show_transform_handles="0"
               live_outline="1"
               live_objects="1"
               show_helperpath="0"
               edit_clipping_paths="0"
               edit_masks="0" />
            <eventcontext
               id="marker"
               selcue="1"
          ...
          <group
             ...
             org.inkscape.template.paper.max="297.0"
             org.inkscape.template.paper.min="210.0"
             org.inkscape.template.paper.orientation="port"
             org.inkscape.template.paper.unit="mm" />
          <group
             id="desktop"
             style="fill:#000000;text-orientation:auto">
            <group
               width="1280"
               height="1396"
               x="0"
          ...
          <group
            ...
            <group
               ...
               symbolicSuccessColor="10029823"
               symbolicWarningColor="4279865599"
               symbolicErrorColor="10086143" />
          </group>
        </inkscape>
      '';
  ...
  config = lib.mkIf config.inkscape.enable {
    ...
    home.file.".config/inkscape/preferences.xml".text = config.inkscape.config;
  };
}
